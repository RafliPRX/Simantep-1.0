                    ...
                    <div className='box1'>                    
                        <form onSubmit={handleUpdateAkun}>
                              <div className='content-f'>                                                    
                                ...
                                <select onChange={handleChangeNama} value={nama} name="" id="">
                                ...
                                <input onChange={handleChangeUsername} value={username} required placeholder='Username' type="text" />
                                <label htmlFor="">Password</label>
                                <input onChange={handleChangePassword} value={password} placeholder='Password' type="password" />
                                <label htmlFor="">Re-Password</label>
                                <input onChange={handleChangeRe_Password} value={re_password} placeholder='re_Password' type="password" />
                                <label htmlFor="">NIP / NRK</label>
                                <input onChange={handleChangeNIP_NRK} required value={nip_nrk} placeholder='NIP / NRK' type="text" />
                                <label htmlFor="">Jabatan</label>
                                <input onChange={handleChangeJabatan} required value={jabatan} placeholder='Jabatan' type="text" />
                                <label htmlFor="">Nama Role</label>
                                <input placeholder='Nama Role' type="text" required value={nama_role} readOnly/>
                                <label htmlFor="">Akses Level</label>
                                <input placeholder='Akses Level' type="text" required value={akses_level} readOnly/>
                              </div>
...
export default Detail_Account_Form_lv1;