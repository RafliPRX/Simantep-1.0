...
const Detail_Identity_Form_lv1 = () => {
                        ...
                        <form onSubmit={handleUpdateIdentitas}>
                          <div className='content-f'>                                                    
                            ...
                            <select onChange={handleChangeNamaRole} name="" id="">
                              <option value={nama_role}>{nama_role} (default)</option>
                            {allrole.map((item) => (
                                <>                                                                                    
                                  <option key={item.id_role} value={item.nama_role}>{item.nama_role}</option>                                        
                                </>
                            ))}
                            </select>
                            ...
                            <select onChange={handleChangeNamaRole_level2} name="" id="">
                              <option value={nama_role_c}>{nama_role_c} (default)</option>
                            {allrole_c.map((item) => (
                                <>                                                                                    
...
export default Detail_Identity_Form_lv1;