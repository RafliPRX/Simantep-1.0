...
const Detail_Identity_Form_lv3 = () => {
    ...
    const [nama_role_b, setNamaRole_b] = useState(identityData.nama_role_b);
    const [kode_role_b, setKodeRole_b] = useState(identityData.kode_role_b);
    ...
    const getIdentityData = async () => {
      try {
            ...
            setNamaRole_b(response.data.nama_role_b);
            setKodeRole_b(response.data.kode_role_b);
        } catch (error) {
            console.error(error);
        }
    }
                      ...
                      <div className='tab-identity'>                            
                        ...
                        <form onSubmit={handleUpdateIdentitas}>
                              <div className='content-f'>                                                    
                                ...
                                <select onChange={handleChangeNamaRole_level3} value={nama_role_b} name="" id="">
                                  <option value={nama_role_b} selected>{nama_role_b}</option>
                                  {allrole_b.map((item) => (
                                      <>                                                                                      
                                ...
                                <label htmlFor="">Kode Role</label>
                                <input placeholder='Kode Role' onChange={handleChangeSisa_Cuti} type="text" value={sisa_cuti}/>
                              </div>                          
...
export default Detail_Identity_Form_lv3;