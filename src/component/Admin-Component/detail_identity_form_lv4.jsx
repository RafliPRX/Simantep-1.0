...
const Detail_Identity_Form_lv4 = () => {
    ...
    const [nama_role_a, setNamaRole_a] = useState(identityData.nama_role_a);
    const [kode_role_a, setKodeRole_a] = useState(identityData.kode_role_a);
    ...
    const getIdentityData = async () => {
      try {
            ...
            setNamaRole_a(response.data.nama_role_a);
            setKodeRole_a(response.data.kode_role_a);
        } catch (error) {
            console.error(error);
        }
    }
                      ...
                      <div className='tab-identity'>                            
                        ...
                        <form onSubmit={handleUpdateIdentitas}>
                              <div className='content-f'>                                                    
                                ...
                                <select onChange={handleChangeNamaRole_level4} value={nama_role_a} name="" id="">
                                  <option value={nama_role_a} selected>{nama_role_a}</option>
                                  {allrole_a.map((item) => (
                                      <>                                                                                      
...
export default Detail_Identity_Form_lv4;