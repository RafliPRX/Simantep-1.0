...
const Detail_Role_Form_Lv1 = () => {
    ...
    const [role_lv1_detail, setRoleLv1Detail] = useState([]);
    const [nama_role, setNamaRole] = useState(role_lv1_detail.nama_role);
    const [kode_role, setKodeRole] = useState(role_lv1_detail.kode_role);
    const getDetailRoleLv = async () => {
      try {
            const response = await axios.get(`https://simantepbareta.cloud/API/Admin_API/detail_role_lv1.php?id=${param.id}`, {
                headers: {}
            });
    ...
    const handlePostRole = async (event) => {
      ...
      try {
        const response = await axios.post(`https://simantepbareta.cloud/API/Admin_API/update_role_lv1.php?id=${param.id}`, payload, {
          headers: {
...
export default Detail_Role_Form_Lv1;